...
const PasswordReset = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await api.post(`${server}/user/new-password/${id}`, {
        password,
        confirmPassword,
      });
        ...
        <div className="p-4">
          {tokenValid === null ? (
            ...
            <>
              ...
              <p className="text-center text-sm text-gray-600 mb-8">Choose a strong password for your account</p>
            ...
            <div className="text-center py-10">
              ...
              <Link
                to="/forgot-password"
                className="inline-flex px-6 py-3 bg-lime-600 hover:bg-lime-700 text-white font-medium rounded-lg transition shadow-md"
              >
