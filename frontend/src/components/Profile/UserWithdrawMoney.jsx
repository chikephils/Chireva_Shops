...
const UserWithdrawMoney = () => {
  ...
  const handleWithdraw = async (e) => {
    ...
    try {
      ...
      if (isNewMethod) {
        await api.put(
          `${server}/user/update-user-withdrawal-methods`,
    ...
    <div className="h-full bg-gray-50 pb-10">
      ...
      <div className="max-w-4xl mx-auto px-3 lg:px-8 pt-6 space-y-6 h- h-[calc(100%-52px)] overflow-y-scroll scrollbar-hide pb-10">
        ...
        <div className="bg-white rounded-xl shadow-sm border p-6 mb-8">
          ...
          <p className="text-2xl font-bold text-gray-900">₦{numbersWithCommas(user?.availableBalance || 0)}</p>
        ...
        <div className="bg-white rounded-xl shadow-sm border overflow-hidden">
          <div className="p-6 border-b bg-gray-50">
            <h2 className="text-lg lg:text-base font-semibold text-gray-900">
